...
from .biformer import biformer_tiny
from .FeatureFusionMLP import FeatureFusionMLP
model_urls = {
...
class ResNet(nn.Module):
    ...
    def __init__(self, block, layers, num_classes=7, zero_init_residual=False,
        ...
        # biformer
        self.model_ft = biformer_tiny(pretrained=False)

        # mlp 2048
        self.mlp = FeatureFusionMLP(biformer_dim=512, resnet_dim=512, hidden_dim=256, output_dim=num_classes)
