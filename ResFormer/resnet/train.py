...
if __name__ == "__main__":
    ...
    #   修改成自己对应的种类的txt
    #----------------------------------------------------#
    classes_path    = '/home/hmxu/shiyan/物候实验/分类代码/resbif/resnet/model_data/cls_classes.txt' 
    #----------------------------------------------------#
    #   输入的图片大小
    #----------------------------------------------------#
    input_shape     = [224, 224]
    ...
    #------------------------------------------------------#
    train_annotation_path   = "/home/hmxu/shiyan/物候实验/分类代码/resbif/resnet/datasets1/cls_train.txt"
    test_annotation_path    = '/home/hmxu/shiyan/物候实验/分类代码/resbif/resnet/datasets1/cls_test.txt'
